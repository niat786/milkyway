      ...
      <section className=" mx-auto lg:max-w-[96rem] p-2 md:px-4 lg:px-20 ">
        <div className="md:p-8 lg:p-10 p-4 border border-dashed rounded-xl ">
          ...
          <div className="flex flex-col space-y-2 text-lg">
            ...
            <p className="font-bold text-transparent bg-clip-text bg-gradient-to-tr from-blue-500 to-blue-900 tracking-wider text-center py-5">
...
<figure className="mx-auto">
  <Image src="/milkyway-play-online-games-(screenshot).webp" alt="online-games-screenshot" width={1000} height={565} className="md:rounded-lg rounded" />
          ...
          <div className="flex justify-center py-5 text-center">
                ...
                <figure>
                  <Image
                    ...
                    alt="milkyway online games - logo"
                    width={500}
                    height={92}
        ...
        >
         <h2 className="text-2xl md:text-3xl my-5">Best Games</h2>
